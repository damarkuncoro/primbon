...
describe('primbon.asatawara', () => {
  it('should return valid Asatawara result for a given date', () => {
    const result = primbon.asatawara(new Date('1990-08-17'));
  ...
  it('should return consistent result for same date', () => {
    ...
    const result1 = primbon.asatawara(date);
    const result2 = primbon.asatawara(date);
